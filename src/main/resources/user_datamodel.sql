...
INSERT INTO redatasense.DB_PROPERTIES (`VENDOR`, `DRIVER`,`USERNAME`,`PASSWORD`,`DBSCHEMA`,`URL`, `ISACTIVE`) VALUES ('mssql', 'com.microsoft.sqlserver.jdbc.SQLServerDriver', 'redglue@redatasense;', 'Slackware3797', 'AdventureWorks', 'jdbc:sqlserver://redatasense.database.windows.net:1433;database=rdsexamples', '0');
INSERT INTO redatasense.DB_PROPERTIES (`VENDOR`, `DRIVER`,`USERNAME`,`PASSWORD`,`DBSCHEMA`,`URL`, `ISACTIVE`) VALUES ('mssql', 'com.microsoft.sqlserver.jdbc.SQLServerDriver', 'redglue@redatasense;', 'Slackware3797', 'SalesLT', 'jdbc:sqlserver://redatasense.database.windows.net:1433;database=rdsexamples', '0');
...
INSERT INTO redatasense.FILE_PROPERTIES (`RKEY`, `RVALUE`) VALUES ('models','model_generic');
...
INSERT INTO redatasense.DATADISCOVERY_PROPERTIES (`RKEY`, `RVALUE`) VALUES ('score_calculation','no');
INSERT INTO redatasense.DATADISCOVERY_PROPERTIES (`RKEY`, `RVALUE`) VALUES ('extentions','com.strider.datadefender.specialcase.SinDetector.detectSin');
INSERT INTO redatasense.DATADISCOVERY_PROPERTIES (`RKEY`, `RVALUE`) VALUES ('models','model_generic');
INSERT INTO redatasense.DATADISCOVERY_PROPERTIES (`RKEY`, `RVALUE`) VALUES ('dictionary_path','nomes.xml');
INSERT INTO redatasense.DATADISCOVERY_PROPERTIES (`RKEY`, `RVALUE`) VALUES ('NERmodel','NERDictionary');
